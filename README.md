# Project setup
You need to install the dependencies using composer. If you do not have installed you can download it in this [website].(https://getcomposer.org/). Once you have composer installed, update your dependencies
```
$ composer update
```
Once the dependencies are installed you can start the project using PHP
```
